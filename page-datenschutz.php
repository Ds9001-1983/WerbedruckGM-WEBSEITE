...
<section class="section section-white">
    <div class="container">
        <div class="legal-content">
            ...
            <h2>2. Hosting</h2>
            <p>
                Wir hosten die Inhalte unserer Website bei folgendem Anbieter: Alfahosting. Die Nutzung erfolgt 
                auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer 
            ...
            <p style="text-align: center; color: var(--gray-500); margin-top: 3rem;">Stand: <?php echo date( 'd. F Y' ); ?></p>
        </div>
    </div>
</section>
