...
<section class="section section-white">
    <div class="container">
        <div class="contact-grid">
            <!-- Contact Info -->
            <div>
                <h2 style="font-size: 1.875rem; font-weight: 700; color: var(--dark); margin-bottom: 1.5rem;">Kontaktieren Sie uns</h2>
                ...
                <div class="contact-info-item">
                    ...
                    <div>
                        <h4>Adresse</h4>
                        <p>c/o Sonja Gerharz Buchhaltungsbüro<br>Alte Landstr. 57<br>51647 Gummersbach</p>
                    </div>
                </div>
                ...
                <div class="contact-info-item">
                    ...
                    <div>
                        <h4>Telefon</h4>
                        <p><a href="tel:022621088" style="color: var(--primary);">02262-1088</a></p>
                    </div>
                </div>
                ...
                <div class="contact-info-item">
                    ...
                    <div>
                        <h4>E-Mail</h4>
                        <p><a href="mailto:info@Deine-Werbewerkstatt.de" style="color: var(--primary);">info@Deine-Werbewerkstatt.de</a></p>
                    </div>
                </div>
            ...
            <div>
                <div class="card">
                    <div class="card-body" style="padding: 2rem;">
                        <h3 style="font-size: 1.5rem; font-weight: 700; color: var(--dark); margin-bottom: 0.5rem;">Anfrage senden</h3>
                        ...
                        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <label for="privacy">Ich stimme der <a href="<?php echo esc_url( home_url( '/datenschutz/' ) ); ?>">Datenschutzerklärung</a> zu.</label>
                                </div>
                            </div>
