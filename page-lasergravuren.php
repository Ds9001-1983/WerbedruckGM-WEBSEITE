...
<section class="page-hero">
    ...
    <div class="hero-bg" style="background-image: url('<?php echo esc_url( get_template_directory_uri() . '/img/hero/laser-flux-acrylschnitt.jpg' ); ?>');"></div>
    ...
    <div class="container">
        <div class="service-content-grid">
            ...
            <div class="reveal-right">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/img/content/laser-sokehui-holzgravur.jpg' ); ?>" alt="Lasergravur">
            </div>
        </div>
        ...
        <div class="mb-16">
            ...
            <div class="examples-grid" style="margin-top: 2rem;">
                <div class="reveal stagger-1">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/img/thumb/laser-acryl-hand.jpg' ); ?>" alt="Holzgravur Beispiel">
                    <h4>Personalisierte Holzartikel</h4>
                    <p>Individuelle Gravuren für Geschenke und Dekoration</p>
                </div>
                <div class="reveal stagger-2">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/img/thumb/laser-flux-acrylschnitt.jpg' ); ?>" alt="Industrielle Kennzeichnung">
                    <h4>Industrielle Kennzeichnung</h4>
                    <p>Dauerhafte Beschriftung für Maschinen und Bauteile</p>
                </div>
                <div class="reveal stagger-3">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/img/thumb/laser-sokehui-holzgravur.jpg' ); ?>" alt="Acryl Werbeschilder">
                    <h4>Acryl-Werbeschilder</h4>
                    <p>Hochwertige Schilder für professionelle Präsentation</p>
                </div>
                <div class="reveal stagger-4">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/img/thumb/laser-acryl-hand.jpg' ); ?>" alt="Schilder & Plaketten">
                    <h4>Schilder & Plaketten</h4>
                    <p>Professionelle Beschilderung für Unternehmen</p>
                </div>
                <div class="reveal stagger-5">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/img/thumb/laser-sokehui-holzgravur.jpg' ); ?>" alt="Lasermaschine">
